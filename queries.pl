...
numero_total_faturado(Time_stamp_inicial,Time_stamp_final,Valor_faturado) :-
	aggregate_all(sum(Preco),
		(encomenda(_,_,_,_,_,Preco,_,Time,_,_,true),mybetween(Time_stamp_inicial,Time_stamp_final,Time)),
		Valor_faturado).
...
quantas_vezes_usou_transporte(Time_stamp_inicial,Time_stamp_final,Meio_transporte,(Vezes_usado,Meio_transporte)) :-
	aggregate_all(count,
		(encomenda(_,_,_,_,_,_,_,Time,_,Meio_transporte,true),mybetween(Time_stamp_inicial,Time_stamp_final,Time)),
		Vezes_usado).
...
numero_total_entregas(Time_stamp_inicial,Time_stamp_final,Numero_total_entregas) :-
	aggregate_all(count,
		(encomenda(_,_,_,_,_,_,_,Time,_,_,true),mybetween(Time_stamp_inicial,Time_stamp_final,Time)),
...
peso_total_entrege(Time_stamp_inicial,Time_stamp_final,Peso_total) :-
	aggregate_all(sum(Peso),
		(encomenda(_,_,_,_,_,Peso,_,Time,_,_,true),mybetween(Time_stamp_inicial,Time_stamp_final,Time)),
		Peso_total).