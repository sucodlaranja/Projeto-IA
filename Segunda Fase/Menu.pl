...
menu(X) :-
    ...
    writeln('4 - Consultar circuitos'),
    writeln('5 - Adicionar estafeta'),
    writeln('6 - Adicionar transporte'),
    writeln('7 - Adicionar encomenda'),
    writeln('8 - Verificar estatisticas encomendas'),
    writeln('9 - Dar entrega da encomenda'),
    writeln('10 - Verificar tabela de precos'),
    writeln('11 - Mudar tabela de precos'),
    writeln('12 - Testar com entrega de varias encomendas'),
    writeln('13 - Exit'),
    choose(X).
